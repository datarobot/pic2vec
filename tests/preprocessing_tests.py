...
from image_featurizer.feature_preprocessing import convert_single_image, \
...
def test_convert_single_image():
    ...
    x1 = convert_single_image('url','http://i2.wp.com/roadsandkingdoms.com/uploads/2013/11/Jorge_Luis_Borges.jpg')
    x2 = convert_single_image('url','http://i2.wp.com/roadsandkingdoms.com/uploads/2013/11/Jorge_Luis_Borges.jpg', grayscale=True)
    x3 = convert_single_image('url','http://i2.wp.com/roadsandkingdoms.com/uploads/2013/11/Jorge_Luis_Borges.jpg', target_size=(299,467))
    x4 = convert_single_image('url','http://i2.wp.com/roadsandkingdoms.com/uploads/2013/11/Jorge_Luis_Borges.jpg', grayscale=True, target_size=(299,467))
...
def test_create_csv_with_image_names():
    ...
    _create_csv_with_image_names(list_of_images, new_csv_path, image_column_header)
